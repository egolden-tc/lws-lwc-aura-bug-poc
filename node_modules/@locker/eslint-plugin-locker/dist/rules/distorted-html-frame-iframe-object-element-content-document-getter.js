...
exports.default = eslint_rule_maker_1.createRule({
    meta: {
        docs: {
            description: `distort HTML{Frame|IFrame|Object}Element#contentDocument getter`,
            category: 'Lightning Locker',
            recommended: true,
            url: util_1.docURL('distorted-html-frame-iframe-object-element-content-document-getter'),
        },
    },
    rule: {
        message: util_1.createGetterMessageHandler(),
